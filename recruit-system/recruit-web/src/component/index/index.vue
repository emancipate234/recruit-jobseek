...
<div class="sacroll-warp">
	...
	<!-- 注册框 -->
	<div>
		<el-drawer title="企慧通" :visible.sync="showregister" :direction="direction" :before-close="handleClose1">
	...
	<!-- 登录框 -->
	<div>
		<el-drawer title="企慧通" :visible.sync="showlogin" :direction="direction" :before-close="handleClose">
	...
	<!-- 忘记密码 -->
	<div>
		<el-drawer title="企慧通" :visible.sync="showfind" :direction="direction" :before-close="handleClose2">
			<el-card class="box-card" style="margin-top: 20%;">
