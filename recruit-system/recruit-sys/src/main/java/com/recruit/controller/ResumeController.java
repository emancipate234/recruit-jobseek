 ...
 * create：创建简历；
 * update：根据用户id更新简历；
 * getByUserId：根据用户id查询简历；
 * get：根据id查询简历；
 * getEducations：根据简历id获取所有教育经历；
 * updateEducation：更新教育经历；
 * addEducation：添加教育经历；
 * delEducation：根据id删除教育经历；
 * getProjects：根据简历id获取所有项目经历；
 * updateProject：更新项目经历；
 * addProject：添加项目经历；
 * delProject：根据id删除项目经历；
 * getExperiences：根据简历id获取所有实习经历；
 * updateExperience：更新实习经历；
 * addExperience：添加实习经历；
 * delExperience：根据id删除实习经历。
*/
@RestController
